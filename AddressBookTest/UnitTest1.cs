...
namespace AddressBookTest
{
    ...
    public class UnitTest1
    {
        ...
        public void OnCallingGetAPI_ReturnAddressBookList()
        {
            ...
            Assert.AreEqual(4, AddressBookList.Count);
        ...
        public void OnCallingPostAPI_ReturnAddressBookObject()
        {
           ...
           // jsonObj.Add("id", );
            jsonObj.Add("FirstName", "Aaryan");
            jsonObj.Add("LastName", "Shekhar");
            jsonObj.Add("Address", "Delhi");
            jsonObj.Add("City", "C");
            jsonObj.Add("State", "M");
            jsonObj.Add("ZipCode", "425477");
            jsonObj.Add("PhoneNumber", "4872392");
            jsonObj.Add("Email", "Arya1@gmail.com");
            ...
            Assert.AreEqual("Aaryan", address.FirstName);
        ...
        public void OnCallingPostAPIForAddressBookListWithMultipleAddress_ReturnEmployeeObject()
        {
            ...
            addressBooks.Add(new AddressBook { FirstName = "Rahul", LastName = "Anand", Address = "Street ABC", City = "Allahabad", State = "UttarPradesh", ZipCode = "239292", PhoneNumber = "8798979898", Email = "Oqqsj@gmail.com" });
        ...
        public void OnCallingPutAPI_ReturnContactObjects()
        {
            ...
            JsonObject jsonObj = new JsonObject();
            jsonObj.Add("FirstName", "SACHIN");
            jsonObj.Add("LastName", "ten");
            ...
            Assert.AreEqual(HttpStatusCode.OK, response.StatusCode);
            AddressBook address = JsonConvert.DeserializeObject<AddressBook>(response.Content);
            Assert.AreEqual("SACHIN", address.FirstName);
            Assert.AreEqual("ten", address.LastName);
        ...
        {
            RestRequest request = new RestRequest("/AddressBookJson/1", Method.DELETE);
